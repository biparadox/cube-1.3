...
yes|cp instance/transfer/plugin_config.cfg.forceattack instance/transfer/plugin_config.cfg 
yes|cp instance/transfer/aspect_policy.cfg.forceattack instance/transfer/aspect_policy.cfg 
