...
enum enum_http_server_result
{
	...
	ENUM(HTTP_SERVER_RESULT,ERR_NOTCLIENT=0x102),	
	ENUM(HTTP_SERVER_RESULT,ERR_TIMEOUT=0x103),	
	ENUM(HTTP_SERVER_RESULT,ERR_NOTCONN=0x104),	
	ENUM(HTTP_SERVER_RESULT,ERR_NOTFOUND=0x105),	
	ENUM(HTTP_SERVER_RESULT,ERR_NOTMATCH=0x106)	
};
